...
namespace ImAdd
{
	...
	IMGUI_API bool          RadioButtonIcon(const char* icon, const char* label, int current_id, int* id_parent, const ImVec2& size_arg = ImVec2(0, 0), ImGuiCol active_col = ImGuiCol_Button, bool borders = true);
	IMGUI_API bool          Checkbox(const char* label, bool* v, bool padding = false);
	...
	IMGUI_API void          BeginChildGroup(const char* label, const ImVec2& size_arg = ImVec2(0, 0));
