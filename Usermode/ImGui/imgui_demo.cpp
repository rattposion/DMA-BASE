...
static void DemoWindowWidgetsBasic()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        ImGui::TextLinkOpenURL("Hyperlink", "");
...
static void DemoWindowWidgetsComboBoxes()
{
    ...
    if (ImGui::TreeNode("Combo"))
    {
        ...
        // See  for advanced/esoteric alternatives.
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("FAQ", "");
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Wiki", "");
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Extensions", "");
    ImGui::SameLine();
